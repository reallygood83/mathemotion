...
def get_sheet_data(service, spreadsheet_id, range_name):
    ...
    try:
        ...
        survey_columns = {
            '📌 학생 번호를 선택하세요.': '학번',
            '🧑‍🎓 학생 이름을 입력하세요.': '학생 이름',
            '🤩 오늘 수학 수업이 기대돼요.': '수업 기대도',
            '😨 오늘 수학 수업이 좀 긴장돼요.': '긴장도',
            '🎲 오늘 배우는 수학 내용이 재미있을 것 같아요.': '재미 예상도',
            '💪 오늘 수업을 잘 해낼 자신이 있어요.': '자신감',
            '🎯 지금 수업에 집중하고 있어요.': '집중도',
            '😆 지금 수업이 즐거워요.': '즐거움',
            '🌟 이제 수학 공부에 자신감이 더 생겼어요.': '자신감 변화',
            '🎉 수업 후에 수학이 전보다 더 재미있어졌어요.': '재미 변화',
            '😌 수업 후에는 수학 시간에 전보다 덜 긴장돼요.': '긴장도 변화',
            '🧠 오늘 수업 내용을 잘 이해했어요.': '이해도',
